...
CREATE PROCEDURE [dbo].[AddBook]
	...
	@languageId int
AS
	insert into Book ([Name],[Resume],PublicationDate,LanguageId)
	values (@name,@Resume, @date,@languageId)
RETURN 0
GO
...
AS
	SELECT b.Id as BookId,b.[Name] as BookName,b.Resume,b.PublicationDate,a.Firstname,a.[Name] as AuthorName,a.Birthdate, g.Id as [GenreId], g.[Name] as GenreName, l.[Name] as LanguageName 
	from Book b
	join BookAuthor ba
	on b.Id = ba.BookId 
	join Author a
...
CREATE PROCEDURE [dbo].[SelectAllInfoBorrowingByUserId]
	@Id int
AS
	SELECT b.Id as borrowingId, b.DateBack, b.DateBegin, b.Additional, c.Id as CopyId, bo.Id as BookId, bo.[Name] as BookName,bo.[Resume], bo.PublicationDate
	from Borrowing b
	join [Copy] c
...
CREATE PROCEDURE [dbo].[SelectBookAuthorById]
	@Id int
AS
	SELECT b.Id as BookId,b.[Name] as BookName,b.[Resume],b.PublicationDate,a.Id as [AuthorId],a.Firstname,a.[Name] as AuthorName,a.Birthdate, g.Id as [GenreId], g.[Name] as GenreName, l.[Name] as LanguageName 
	from Book b
	join BookAuthor ba
	on b.Id = ba.BookId 
	join Author a
